...
Revision ID: 2eed375c519c
Revises: 
Create Date: 2025-11-27 20:55:00.308336
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_public_users_organization_id'), 'users', ['organization_id'], unique=False, schema='public')
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_public_users_organization_id'), table_name='users', schema='public')
